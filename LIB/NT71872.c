...
static const LcmStru Lcm[] = {
    {
        .Name = "LQ156M1JW22",     //Annie2
        .Flow   = &Flow_WBkRGB_2s,  
    },{
        .Name = "LQ156M1JW09",     //Alena3
        .Flow   = &Flow_WBk_100ms,  
    },{
        .Name = "LQ156M1JW22",     //Annie2
        .Flow   = &Flow_WBk_100ms,      
    },{
        .Name = "LQ156M1JW03",     //Alena
        .Flow   = &Flow_WBk_100ms,
    },{
        .Name = "LQ156M1JW08",     //Alena2
        .Flow   = &Flow_WBk_100ms,       
    },{    
        .Name = "LQ156M1JW16",     //Alena5
        .Flow   = &Flow_WBk_100ms,  
    },{
        .Name = "LQ156M1JW26",     //Alena6 
        .Flow   = &Flow_WBk_100ms,      
    },{
        .Name = "LQ156M1JW17",     //Asia
        .Flow   = &Flow_WBk_100ms,
    },{
        .Name = "LQ156M1JW18",     //Asia2
        .Flow   = &Flow_WBk_100ms,       
    },{
        .Name = "LQ156M1JW23",     //Asia3
        .Flow   = &Flow_WBk_100ms,
    },{
        .Name = "LQ156M1JW25",     //Asia4
        .Flow   = &Flow_WBk_100ms,       
    },    
};

const TconStru NT71872 ={ 
    .PowerOnSeq = PowerOn,
...
uint8 tx[] = {0xFF, 0xA5, 0x0B, 0x00, 0x82, 0x20, 0x00};
uint8 rx[11];
uint8 num;
BOOL Rslt = FALSE;
LcmStru *pLcm;
...
static void DispPattern(uint8 p){
   switch(p){
     ...
     case 2:  TCON_WriteReg_5(0xf0, 0x04, 0x3f, 0x00, 0x00);  //r
           break;
     case 3:  TCON_WriteReg_5(0x00, 0xf1, 0x00, 0x00, 0x3f);  //b
           break;
     case 4:  TCON_WriteReg_5(0x0f, 0x02, 0x00, 0x3f, 0x00);  //g
           break;
    }
}
...
static void PowerOn(void){
    SetGPIO(PWR_VDD, HIGH);
    _delay_ms(200);
    TCON_WriteReg(0x0132, 0xF0);
    TCON_WriteReg(0x020D, 0x84);
    _delay_ms(200);
    DispPattern(0);
